...
public class GestionHabitaciones{
    ...
    // definir tamaño 
    public GestionHabitaciones(int tamano) {
    ...
    public boolean crear(Habitacion habitacion) {
        if (cantidadActual < this.habitaciones.length) {
    ...
    public boolean modificar(Habitacion habitacionActualizada) {
        // Buscar habitacion por el ID
        Habitacion h = buscarPorId(String.valueOf(habitacionActualizada.getNumero()));
        if (h != null) {
            //Actualizar datos
            h.setCapacidadMaxima(habitacionActualizada.getCapacidadMaxima());
            h.setPrecioPorNoche(habitacionActualizada.getPrecioPorNoche());
    ...
    public boolean eliminar(int numero){
        return eliminar(String.valueOf(numero));
    }
